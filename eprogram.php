...
if (!isset($meetId)) {
	...
	addlog("Access", "Accessed eprogram.php no meet selected.");
...
addlog("Access", "Accessed eprogram.php meet $meetId");
...
if ($eProgram->exists()) {
	...
	echo "<p>\n";
	echo "<a href=\"eprogram.php?id=$meetId&byheat=1\">List by Heat</a>";
	echo " | <a href=\"eprogram.php?id=$meetId&byage=1\">List by Age Group</a>";
	echo " | <a href=\"eprogram.php?id=$meetId&teamscores=1\">Team Scores</a>\n"; 
	echo " | <a href=\"eprogram.php?id=$meetId&individualProg=1\">Individual Program</a>\n";
	echo " | <a href=\"eprogram.php?id=$meetId&teamProg=1\">Team Program</a>\n";
	echo "</p>\n";
	...
	if (isset($_GET['byheat'])) {
		...
		echo "<form method=\"get\" action=\"eprogram.php?id=$meetId&individualProg=1\">\n";
		echo "<p>\n";
		...
		// Get swimmer selection drop down box
		echo "<form method=\"get\" action=\"eprogram.php?id=$meetId&teamProg=1\">\n";
		echo "<p>\n";
