...
if (isset($meetId) && isset($eventId)) {
    ...
    $relayEntries = $GLOBALS['db']->getAll("SELECT a.id, b.meetname, c.code, c.clubname, d.prognumber, 
    ...
    foreach ($relayEntries as $r) {
        ...
        // Get relay members
        $relayMembers = $GLOBALS['db']->getAll("SELECT member.firstname, member.surname,  IF(member.gender = 1, 'M', 'F') as gender, 
